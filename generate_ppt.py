...
def create_pitch_deck():
    ...
    p5 = tf.add_paragraph()
    p5.text = "• Python GIL (Global Interpreter Lock) Bottleneck"
    p5.font.size = Pt(16)
    p5.font.bold = True
    ...
    p6 = tf.add_paragraph()
    p6.text = "  - Native Python nodes serialize executions, bottlenecking GPU throughput and driving latency up to 1.76s."
    p6.font.size = Pt(14)
    ...
    p3 = tf.add_paragraph()
    p3.text = "• BAML-Inspired Auto-Heal Parser (SapParser)"
    p3.font.size = Pt(16)
    p3.font.bold = True
    p3.font.color.rgb = PURE_WHITE
    p3.font.name = "Segoe UI"
    p4 = tf.add_paragraph()
    p4.text = "  - Dynamically repairs broken JSON schemas on-the-fly, completely eliminating format-related timeout penalties."
    p4.font.size = Pt(14)
    p4.font.color.rgb = CHARCOAL_MUTED
    p4.font.name = "Segoe UI"

    p5 = tf.add_paragraph()
    p5.text = "• Asynchronous GIL Bypass Engine"
    p5.font.size = Pt(16)
    p5.font.bold = True
    p5.font.color.rgb = PURE_WHITE
    p5.font.name = "Segoe UI"
    p6 = tf.add_paragraph()
    p6.text = "  - Bypasses Python interpreter serialization bottlenecks, crushing response latency down to 0.42s."
    p6.font.size = Pt(14)
    p6.font.color.rgb = CHARCOAL_MUTED
    p6.font.name = "Segoe UI"
